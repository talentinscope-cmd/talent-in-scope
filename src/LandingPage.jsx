...
const translations = {
  en: {
    ...
    features: {
      ...
      subtitle: 'Powerful insights updated monthly',
      items: [
        {
          icon: 'TrendingUp',
          title: 'Real-Time Workforce Intelligence',
          description: 'See exactly how many employees are actively looking for opportunities with comprehensive monthly reports.'
        },
        {
          icon: 'BarChart3',
    ...
    contact: {
      title: 'Get Started',
      subtitle: 'Request access to see how Talent In Scope can help your organization',
  ...
  tr: {
    ...
    features: {
      ...
      subtitle: 'Aylık olarak güncellenen güçlü içgörüler',
      items: [
        {
          icon: 'TrendingUp',
          title: 'Gerçek Zamanlı İş Gücü İstihbaratı',
          description: 'Kapsamlı aylık raporlarla aktif olarak iş arayan çalışan sayısını tam olarak görün.'
        },
        {
          icon: 'BarChart3',
    ...
    contact: {
      title: 'Başlayın',
      subtitle: 'Talent In Scope\'un organizasyonunuza nasıl yardımcı olabileceğini görmek için erişim talep edin',
